...
//#include  "/home/c/Downloads/chromium1/src/base/android/jni_generator.h"

#include "src/base/android/jni_generator/jni_generator_helper.h"
//#include "base_jni_headers/base/jni/LibraryLoader_jni.h"
#include "src/out/Default/gen/base/base_jni_headers/base/jni/LibraryLoader_jni.h"

//#include "src/base/android/library_loader/library_loader_hooks.h"
//#include "src/base/android/library_loader/library_loader_hooks.cc"
//#include "src/components/cronet/android/cronet_library_loader.cc"

//#include ""


#include "src/base/android/jni_int_wrapper.h"
...
JNI_GENERATOR_EXPORT void
  ...
  return RegisterLibraryPreloaderRendererHistogram(env,
      base::android::JavaParamRef<jobject>(env, jcaller), status);
        ...
        // static
 base::android::ScopedJavaLocalRef<jstring> GetVersionNumber(JNIEnv* env,
